...
public abstract class AbstractDispatcherServletTest implements AfterRunService {
	...
	public AbstractDispatcherServletTest initRequest(String requestUrl, String method) {
		this.request = new MockHttpServletRequest(method, requestUrl);
	...
	public AbstractDispatcherServletTest initRequest(String requestUrl, RequestMethod method) {
		return this.initRequest(requestUrl, method.name());
	}

	public AbstractDispatcherServletTest initRequest(String requestUrl) {
		initRequest(requestUrl, RequestMethod.GET);
		return this;
	}
